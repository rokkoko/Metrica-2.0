...
Сервер и база данных на Хероку, приложение `a-metrica`, https://git.heroku.com/a-metrica.git, данные расшарены среди 
...
- Собственный телеграм-бот для интеграции с Телеграмом: реакции на команды (`/add` и т.п.) и реквест на сервер Django, 
  и второй - реакция на входящий реквест `process_update` (вебхук) и отсылка сообщения в Телеграм;
