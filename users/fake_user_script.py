...
def fake_users(iteration):
    ...
    for _ in range(iteration):
        CustomUser.objects.create_user(username=fake.user_name(), first_name=fake.first_name(), last_name=fake.last_name(), password=fake.password(), email=fake.ascii_email())
